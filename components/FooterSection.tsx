            ...
            <div className="flex gap-[10px] pt-4">
              {SocialLinks.map((social, i) => (
                <a 
                  ...
                  className="w-8 h-8 rounded-md flex items-center justify-center transition-all cursor-pointer bg-white/[0.06] text-white/70 hover:bg-white/[0.12] hover:text-white"
                  title={social.name}
                >
